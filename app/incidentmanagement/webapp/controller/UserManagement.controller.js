sap.ui.define([
    ...
    return Controller.extend("com.amista.incidentmanagement.incidentmanagement.controller.UserManagement", {
        ...
        onAddUser: function () {
            ...
            const oIdInput = new Input({ placeholder: "e.g. USR006" });
            ...
            const oDialog = new Dialog({
                ...
                content: [
                    new SimpleForm({
                        editable: true,
                        content: [
                            new Label({ text: "User ID", required: true }),
                            oIdInput,
                ...
                beginButton: new Button({
                    ...
                    press: async function () {
                        ...
                        if (!sId || sId.trim() === "") {
                            MessageBox.error("Please enter a User ID");
                            return;
                        }
                        if (!sName || sName.trim() === "") {
            ...
            MessageBox.confirm("Are you sure you want to delete the selected user?", {
                onClose: async function (sAction) {
                    if (sAction === MessageBox.Action.OK) {
                        this.getView().setBusy(true);
                        try {
                            const oContext = oSelectedItem.getBindingContext("admin");
        ...
        onAssignIncident: function () {
            ...
            const oUserContext = oSelectedItem.getBindingContext("admin");
            ...
            const oDialog = new Dialog({
                ...
                beginButton: new Button({
                    ...
                    press: async function () {
                        ...
                        const oIncidentContext = oSelectedIncidentItem.getBindingContext("admin");
                        const oModel = this.getOwnerComponent().getModel("admin");
